...
namespace RaraAvis.Sprocket.RuleEngine.Elements.Operates
{
        ...
        where TElement : IElement
    {
        ...
        //public static Operator<TElement> operator %(Command<TElement, TValue> command, Operator<TElement> jump)
        //{
        //    Jump<TElement> jmp = new Jump<TElement>(command, jump);
        //    return jmp;
        //}

        //public static Operator<TElement> operator %(Command<TElement, TValue> command, (Operator<TElement>, Operator<TElement>) jump)
        //{
        //    Jump<TElement> jmp = new Jump<TElement>(command, jump);
        //    return jmp;
        //}
