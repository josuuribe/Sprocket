...
namespace RaraAvis.Sprocket.Tests.Fakes.System
{
    public class ActivateRuleEngine
    {
        ...
        {
            reas = new RuleEngineActivatorService<Person>();
            res = reas.GetRuleEngine(Path.Combine(Path.GetDirectoryName(typeof(ActivateRuleEngine).GetTypeInfo().Assembly.Location), "RaraAvis.Sprocket.dll"));
